...
const topics = {
  ...
  vue_get_started: {
    ...
    similar: [
      ...
      'Vue hello world',
      'Vue for newbies',
      'Things every Vue.js beginner should know',
      'Vue starter kit',
      'Vue tutorials for beginners',
      'Best way to learn Vue',
      'How to run Vue'
    ]
  },
  vue_components: {
    ...
    similar: [
      ...
      'How to write Vue component',
      'Communication between Vue components',
      'Best practices to write a Vue component',
      'Vue stateless components',
...
compiler would attach specified behavior to.`
  ...
  vue_lifecycle_methods: {
    ...
    similar: [
      ...
      'How to use Vue.js Component Lifecycle Methods',
      'When to use Vue Lifecycle',
      'State and Lifecycle in Vue',
  ...
  vue_events: {
    ...
    slug: 'vue-events',
    similar: [
      'How to work with events in Vue',
      'Vue event click',
      'Vue onclick pass parameter'
    ]
  },
  vue_patterns: {
  ...
  vue_styling: {
    ...
    slug: 'vue-style',
    similar: [
      'Ways to style Vue components',
      'Inline Styles with Vue',
      'Vue style attribute',
      'Using CSS Modules with Vue'
    ]
  },
  vue_case_studies: {
